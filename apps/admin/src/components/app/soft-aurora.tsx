// Soft Aurora background — ported verbatim from react-bits
// (DavidHDev/react-bits) src/ts-default/Backgrounds/SoftAurora/SoftAurora.tsx
// WebGL shader via ogl. Uses two color stops; we feed the Narah Twilight palette.
